...
// Two variants so the wordmark stays legible on both dark + light
// surfaces. Generated by scripts/build-logo-variants.js from logo.jpeg.
  ...
  return (
    <>
      <View style={[styles.header, { backgroundColor: colors.bg0, borderBottomColor: colors.border }]}>
        {/* Left — Wordmark image (theme-aware dark/light variants) */}
...
const styles = StyleSheet.create({
  ...
  left: {},
  wordmarkImg: { width: 130, height: 32 },
